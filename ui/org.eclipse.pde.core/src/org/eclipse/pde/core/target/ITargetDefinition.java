...
public interface ITargetDefinition {
	 ...
	 * updated with each setter that has an affect on the target file source. If the
	 * state of the target is unable to be kept in the document it will be removed
