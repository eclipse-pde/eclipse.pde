 ...
 */
public class FileMetadataRepository extends AbstractMetadataRepository {
	private final List<IInstallableUnit> installableUnits;

	public FileMetadataRepository(IProvisioningAgent agent, List<IInstallableUnit> installableUnits) {
		super(agent);
