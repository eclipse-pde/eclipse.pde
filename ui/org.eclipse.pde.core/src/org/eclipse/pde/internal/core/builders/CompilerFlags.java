...
import org.eclipse.pde.internal.core.natures.PDEProject;
...
public class CompilerFlags {
	...
	public static String getString(IProject project, String flagId) {
		...
		return service.getString(PDEProject.PLUGIN_ID, flagId, "", project == null ? null : contexts); //$NON-NLS-1$
	}
	...
	public static void save() {
		try {
			InstanceScope.INSTANCE.getNode(PDEProject.PLUGIN_ID).flush();
