...
public class BndProject extends PDEProject {

	public static final String NATURE_ID = PLUGIN_ID + ".BndNature"; //$NON-NLS-1$
	...
	public static final String BUILDER_ID = PLUGIN_ID + ".BndBuilder"; //$NON-NLS-1$
