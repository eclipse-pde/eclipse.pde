...
public class FeatureProject extends PDEProject {

	public static final String NATURE = PLUGIN_ID + ".FeatureNature"; //$NON-NLS-1$
	public static final String BUILDER_ID = PLUGIN_ID + ".FeatureBuilder"; //$NON-NLS-1$
