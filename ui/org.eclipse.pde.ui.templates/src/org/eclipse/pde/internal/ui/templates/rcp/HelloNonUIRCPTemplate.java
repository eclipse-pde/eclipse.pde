...
public class HelloNonUIRCPTemplate extends PDETemplateSection {
	...
	private void createOptions() {
		...
		addOption(KEY_APPLICATION_CLASS,
				PDETemplateMessages.HelloNonUIRCPTemplate_appClass,
				"Application", 0); //$NON-NLS-1$
		
		addOption(KEY_APPLICATION_MESSAGE,
				PDETemplateMessages.HelloNonUIRCPTemplate_messageText,
				PDETemplateMessages.HelloNonUIRCPTemplate_defaultMessage, 0); 
	}
