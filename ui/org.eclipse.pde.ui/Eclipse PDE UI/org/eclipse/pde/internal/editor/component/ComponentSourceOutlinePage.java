...
public class ComponentSourceOutlinePage extends ContentOutlinePage {
...
public ComponentSourceOutlinePage(IEditorInput input, IDocumentProvider provider, AbstractTextEditor editor) {
	this.input = input;
