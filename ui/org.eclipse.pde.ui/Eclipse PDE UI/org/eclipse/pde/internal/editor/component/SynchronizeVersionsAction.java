...
public class SynchronizeVersionsAction extends Action {
	...
	public static final String DIALOG_TITLE = "ComponentEditor.modelsInUse.title";
	public static final String DIALOG_MESSAGE = "ComponentEditor.modelsInUse.message";
	
	private ComponentEditor activeEditor;
