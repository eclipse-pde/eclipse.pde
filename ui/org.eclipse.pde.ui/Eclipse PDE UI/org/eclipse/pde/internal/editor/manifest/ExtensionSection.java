...
public class ExtensionSection extends PDEFormSection implements IHyperlinkListener, IModelChangedListener {
...
private void addExtensionLink(IPluginExtension extension) {
	...
	IPluginExtensionPoint pointInfo = PDEPlugin.getDefault().findExtensionPoint(point);
...
public Composite createClient(Composite parent, FormWidgetFactory factory) {
	...
	final IPDEEditorPage targetPage = getFormPage().getEditor().getPage(ManifestEditor.EXTENSIONS_PAGE);
