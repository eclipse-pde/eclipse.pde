 ...
 * @author melhem
 */
public class PluginSourceLabelProvider extends BaseSourceLabelProvider {
	
	/* (non-Javadoc)
	 * @see org.eclipse.pde.internal.ui.editor.manifest.BaseSourceLabelProvider#getImage(java.lang.Object)
	 */
	public Image getImage(Object obj) {
		if (ManifestEditorUtil.isPluginNode(((IDocumentNode)obj).getContent()))
	...
	public String getText(Object obj) {
		...
		String text = null;
		if (ManifestEditorUtil.isPluginNode(node))
