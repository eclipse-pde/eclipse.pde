...
public class XMLDocumentModelBuilder extends DOMBuilderImpl {
	...
	private void endSubtree(Node domNode) {
		...
		//create current node
		IDocumentNode currentNode= fModelFactory.createXMLNode(children, domNode, getLineTable());
	...
	public void xmlDecl(String version, String encoding, String standalone, Augmentations augs) throws XNIException {
		...
		ProcessingInstruction procInstr = fDocument.createProcessingInstruction("xml",version);
		startRange(procInstr);
		endRange(procInstr);
	}
