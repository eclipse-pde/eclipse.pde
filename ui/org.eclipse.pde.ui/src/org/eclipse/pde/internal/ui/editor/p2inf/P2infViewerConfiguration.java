...
public class P2infViewerConfiguration extends ChangeAwareSourceViewerConfiguration {
	...
	public P2infViewerConfiguration(IColorManager colorManager, IPreferenceStore store,
	...
	public IContentAssistant getContentAssistant(ISourceViewer sourceViewer) {
		if (fSourcePage != null && fSourcePage.isEditable()) {
			if (fContentAssistant == null) {
				...
				var fContentAssistantProcessor = new P2InfContentAssistProcessor(fSourcePage);
