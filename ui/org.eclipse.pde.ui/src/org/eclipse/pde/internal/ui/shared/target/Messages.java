...
public class Messages extends NLS {
	...
	public static String RepositoriesDialog_TargetRepositoriesTitle;
	public static String StyledBundleLabelProvider_RemoteRepository;
	...
	public static String TargetLocationsGroup_EditRepos;
