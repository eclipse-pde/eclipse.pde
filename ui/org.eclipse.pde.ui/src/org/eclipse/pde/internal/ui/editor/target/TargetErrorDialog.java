...
public class TargetErrorDialog extends TreeMessageDialog {
	...
	protected static class ErrorDialogContentProvider extends DefaultContentProvider implements ITreeContentProvider {
		...
		public Object[] getElements(Object inputElement) {
			if (fFeatures != null && fPlugins != null)
				return new Object[] {fFeatures, fPlugins};
			else if (fFeatures != null)
				return new Object[] {fFeatures};
			else
				return new Object[] {fPlugins};
		}
	}
	...
	public static void showDialog(Shell parentShell, Object[] features, Object[] plugins) {
		TreeMessageDialog dialog = new TargetErrorDialog(parentShell, PDEUIMessages.TargetErrorDialog_title, null, PDEUIMessages.TargetErrorDialog_description, MessageDialog.WARNING, new String[] {IDialogConstants.OK_LABEL}, 0);
