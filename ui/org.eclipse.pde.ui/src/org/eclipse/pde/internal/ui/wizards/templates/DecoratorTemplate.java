...
public class DecoratorTemplate extends PDETemplateSection { 
	public static String AKEY_PACKAGE_NAME = "decoratorPackageName"; //$NON-NLS-1$
	public static String DECORATOR_CLASS_NAME = "decoratorClassName"; //$NON-NLS-1$
	public static String DECORATOR_ICON_PLACEMENT = "decoratorPlacement"; //$NON-NLS-1$
