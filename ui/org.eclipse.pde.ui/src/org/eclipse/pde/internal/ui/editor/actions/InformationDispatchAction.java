...
/*
 * Based on org.eclipse.ant.internal.ui.editor.actions.InformationDispatchAction
 */
public class InformationDispatchAction extends TextEditorAction {
	...
	public InformationDispatchAction(ResourceBundle resourceBundle, String prefix, TextOperationAction textOperationAction, PDESourcePage editor) {
	...
	public void run() {
		...
		ISourceViewer sourceViewer = ((PDESourcePage)getTextEditor()).getViewer();
		...
		try {
			...
			String contentType = TextUtilities.getContentType(sourceViewer.getDocument(), IDocumentExtension3.DEFAULT_PARTITIONING, offset, true);
			...
			IInformationControlCreator informationControlCreator = new IInformationControlCreator() {
				public IInformationControl createInformationControl(Shell parent) {
					return new DefaultInformationControl(
							parent, SWT.RESIZE, SWT.V_SCROLL | SWT.H_SCROLL, new HTMLTextPresenter(false));
				}
			};
			fInformationPresenter = new InformationPresenter(informationControlCreator);
			fInformationPresenter.setSizeConstraints(60, 10, true, true);		
			fInformationPresenter.install(((PDESourcePage)getTextEditor()).getViewer());
		} 
