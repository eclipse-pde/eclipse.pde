 ...
 */
	...
	/**
	 * Returns the field data passed to the wizard during
	 * the initialization.
...
/**
 * Implements the interface method by looping through template
 * sections and executing them sequentially.
 * @param project the project
 * @param model the plug-in model
 * @param monitor the progress monitor to track the execution
 * progress as part of the overall new project creation operation
 */
	...
	/**
	 * Returns the template sections in this wizard.
 ...
 */
	...
	public String [] getNewFiles() {
		...
		return (String[]) result.toArray(new String[result
			.size()]);
	}
