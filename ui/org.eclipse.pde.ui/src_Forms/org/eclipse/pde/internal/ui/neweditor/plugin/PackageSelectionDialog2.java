 ...
 *
 */
public class PackageSelectionDialog2 extends ElementListSelectionDialog {

	public static final String PACKAGE_MESSAGE = "PackageSelectionDialog.label";
	
	public PackageSelectionDialog2(Shell parent, ILabelProvider renderer, IJavaProject jProject) {
	 ...
	 * @param renderer
	 */
	public PackageSelectionDialog2(Shell parent, ILabelProvider renderer, IJavaProject jProject, Vector existingPackages) {
