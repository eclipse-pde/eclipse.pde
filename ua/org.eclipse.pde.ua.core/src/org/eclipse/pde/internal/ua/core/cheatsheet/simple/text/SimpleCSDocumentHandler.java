...
public class SimpleCSDocumentHandler extends NodeDocumentHandler {
	 ...
	 * 
	 * @see
	 * org.eclipse.pde.internal.core.text.DocumentHandler#startElement(java.
	 ...
	 * 
	 * @see
	 * org.eclipse.pde.internal.core.text.DocumentHandler#endElement(java.lang
	 ...
	 * @param parent
	 */
	private void processCollapsedEndElement(String name,
	 ...
	 * @param parent
	 */
	private void processCollapsedStartElement(String name,
			Attributes attributes, IDocumentElementNode parent) {
		...
		for (int i = 0; i < attributes.getLength(); i++) {
			...
			IDocumentAttributeNode attribute = getDocumentAttribute(attName,
					attValue, node);
			if (attribute != null) {
