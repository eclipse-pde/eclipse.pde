...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<h3>
			Bundles that were not analyzed
		</h3>
			<xsl:choose>
				<xsl:when test="count(components/component) &gt; 0">
				<p>
					The following bundles were referenced but corresponding bundles could not be found in the migration candidate.
				</p>
				<p>
					Click an entry in the table below to reveal the details of why it was not analyzed.
				</p>
