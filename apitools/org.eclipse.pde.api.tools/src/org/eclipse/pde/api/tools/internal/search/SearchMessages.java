...
public class SearchMessages extends NLS {
	...
	public static String ApiUseReportConverter_back_to_not_searched;
	...
	public static String ApiUseReportConverter_te_applying_xslt_skipped;
	public static String ApiUseReportConverter_no_bundle_have_usage;
	public static String ApiUseReportConverter_no_usage_header;
	...
	public static String ApiUseReportConverter_se_error_parser_handle;
	...
	public static String ApiUseReportConverter_missing_bundle_entry;
	public static String ApiUseReportConverter_missing_header;
	...
	public static String ApiUseReportConverter_pce_error_getting_parser;
