...
public class ApiErrorsWarningsConfigurationBlock {
	...
	private static final Key KEY_METHOD_CHANGED_RESTRICTIONS =
		getApiToolsKey(IApiProblemTypes.METHOD_CHANGED_RESTRICTIONS);
	...
	private static Key[] fgAllCompatibilityKeys = {
		...
		KEY_METHOD_CHANGED_RESTRICTIONS,
			...
			case COMPATIBILITY_PAGE_ID : {
				...
				initializeComboControls(
					...
					new String[] {
						...
						PreferenceMessages.METHOD_CHANGED_RESTRICTIONS,
