...
public class ApiErrorsWarningsConfigurationBlock {
	...
	private static Key[] fgAllKeys = {
		...
		KEY_ANNOTATION_ADDED_NOT_IMPLEMENT_RESTRICTION_FIELD,
		KEY_ANNOTATION_ADDED_NOT_IMPLEMENT_RESTRICTION_METHOD,
		KEY_ANNOTATION_ADDED_NOT_IMPLEMENT_RESTRICTION_TYPE_MEMBER,
		...
		KEY_INTERFACE_ADDED_NOT_IMPLEMENT_RESTRICTION_FIELD,
		KEY_INTERFACE_ADDED_NOT_IMPLEMENT_RESTRICTION_METHOD,
		KEY_INTERFACE_ADDED_NOT_IMPLEMENT_RESTRICTION_TYPE_MEMBER,
		...
		KEY_ENUM_ADDED_FIELD_NOT_EXTEND_RESTRICTION,
		KEY_ENUM_ADDED_METHOD_NOT_EXTEND_RESTRICTION,
		...
		KEY_CLASS_ADDED_NOT_EXTEND_RESTRICTION_FIELD,
		KEY_CLASS_ADDED_NOT_EXTEND_RESTRICTION_METHOD,
		...
		KEY_METHOD_CHANGED_NON_FINAL_TO_FINAL_NOT_EXTEND_RESTRICTION,
		...
		KEY_CONSTRUCTOR_CHANGED_NON_FINAL_TO_FINAL_NOT_EXTEND_RESTRICTION,
		...
		switch(kind) {
			...
			case BINARY_COMPATIBILITY_PAGE_ID :
				...
				initializeComboControls(
					client,
					new String[] {
						PreferenceMessages.ANNOTATION_ADDED_NOT_IMPLEMENT_RESTRICTION_FIELD,
						PreferenceMessages.ANNOTATION_ADDED_NOT_IMPLEMENT_RESTRICTION_METHOD,
						PreferenceMessages.ANNOTATION_ADDED_NOT_IMPLEMENT_RESTRICTION_TYPE_MEMBER,
				...
				initializeComboControls(
					client,
					new String[] {
						PreferenceMessages.INTERFACE_ADDED_NOT_IMPLEMENT_RESTRICTION_FIELD,
						PreferenceMessages.INTERFACE_ADDED_NOT_IMPLEMENT_RESTRICTION_METHOD,
						PreferenceMessages.INTERFACE_ADDED_NOT_IMPLEMENT_RESTRICTION_TYPE_MEMBER,
				...
				initializeComboControls(
					client,
					new String[] {
						PreferenceMessages.ENUM_ADDED_FIELD_NOT_EXTEND_RESTRICTION,
						PreferenceMessages.ENUM_ADDED_METHOD_NOT_EXTEND_RESTRICTION,
				...
				initializeComboControls(
					client,
					new String[] {
						PreferenceMessages.CLASS_ADDED_NOT_EXTEND_RESTRICTION_FIELD,
						PreferenceMessages.CLASS_ADDED_NOT_EXTEND_RESTRICTION_METHOD,
				...
				initializeComboControls(
					...
					new String[] {
						...
						PreferenceMessages.METHOD_CHANGED_NON_FINAL_TO_FINAL_NOT_EXTEND_RESTRICTION,
				...
				initializeComboControls(
					...
					new String[] {
						...
						PreferenceMessages.CONSTRUCTOR_CHANGED_NON_FINAL_TO_FINAL_NOT_EXTEND_RESTRICTION,
