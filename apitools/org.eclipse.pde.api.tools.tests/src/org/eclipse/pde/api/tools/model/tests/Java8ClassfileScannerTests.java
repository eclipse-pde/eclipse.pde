...
public class Java8ClassfileScannerTests extends ScannerTest {
	...
	public void testStaticMethodRef() throws Exception {
		...
		assertTrue(ref != null, "There should be a ref for invokedynamic.test1$MR#mrCompare"); //$NON-NLS-1$
	}
	...
	public void testInstanceMethodRef() throws Exception {
		...
		assertTrue(ref != null, "There should be a ref for invokedynamic.test2$MR#mrCompare"); //$NON-NLS-1$
	}
	...
	public void testArbitraryObjectMethodRef() throws Exception {
		...
		assertTrue(ref != null, "There should be a ref for String#compareToIgnoreCase"); //$NON-NLS-1$
	}
	...
	public void testConstructorMethodRef() throws Exception {
		...
		assertTrue(ref != null, "There should be a ref for HashSet#<init>"); //$NON-NLS-1$
	}
